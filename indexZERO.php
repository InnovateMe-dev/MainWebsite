...
<!-- SITE TITLE -->
<title>InnovateMe - A Social Network For Startups</title>
	...
	<div class="navigation-header">
		...
		<div class="navbar non-sticky">
			...
			<div class="container">
				...
				<div class="navbar-header">
					<img src="images/logolong.png" alt="InnovateMe">
				</div>

				<ul class="nav navbar-nav navbar-right social-navigation hidden-xs">
					<li><a href="http://facebook.com/InnovateMeOfficial"><i class="social_facebook_circle"></i></a></li>
					<li><a href="http://twitter.com/InnovateMe_xyz"><i class="social_twitter_circle"></i></a></li>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-7 col-sm-7 intro-section">
				...
				<strong>Join</strong> the Fastest Growing <strong>Social Network</strong> and Launch Your StartUp <strong>Today</strong>
				</h1>
				...
				<ul class="feature-list-1">
					...
					<p class="text-left">
						Connect with your fellow entrepreneurs, both those you know in real life, and those you would like to get to know.
					</p>
					</li>
					...
					<p class="text-left">
						InnovateMe connects you with the people you need to make it happen. </p>
					</li>
					...
					<p class="text-left">
						Individual profiles for you, your startup, and your ideas are all connected.
					</p>
					</li>
					...
					<p class="text-left">
						Because privacy means as much to us as it does to you, we will never share your personal information with any third party.
					</li>
				</ul>
			...
			<div class="col-md-5 col-sm-5">
				...
				<div class="vertical-registration-form">
					...
					<form class="registration-form" id="register" role="form">
						...
						<button class="btn standard-button" type="submit" id="submit" name="submit">Get Started</button>
					</form>
					Already a member? <a href="./login.php" class="login-link">Login</a>
				</div>
			</div>
		...
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="video-container">
				...
				<div class="video">
					...
					<iframe width="640" height="360" src="//www.youtube.com/embed/_ACKPGJOdis?rel=0" frameborder="0" allowfullscreen></iframe>
				</div>
...
<div class="container">
	...
	<div class="footer-logo">
		<img src="images/logodark.png" alt="InnovateMe" class="footer-logo-image">
	</div>
